...
export const charClassesList: TCharClass[] = [
...
export function getClassDescription(charClass: ECharClass): TCharClass {
	return charClassesList.find(ccl => ccl.charClass == charClass)!
}