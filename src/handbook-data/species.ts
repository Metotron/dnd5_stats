...
/** Общий тип, опсиывающий персонажа со всеми его возможностями. Расширяется в разных местах новыми записями */
...
export const baseSpecies: Record<EBaseSpecies, TBaseSpeciesDescription> = {
	[EBaseSpecies.aasimar]: createBaseDescription(EDarkvision.dv60,{
		...
		features: [
			...
			'[Небесное сопротивление.] Сопротивление некротическому урону и урону излучением',
			'[Исцеляющие руки.] Раз в день магическим действием, касаясь существа, восстанавливаете ему {profBonus:}d4 хитов',
	...
	[EBaseSpecies.dragonborn]: createBaseDescription(EDarkvision.dv60, {
		...
		features: ['[Оружие дыхания.] Можете действием выдохнуть разрушительную энергию: 15 фт. конус или линию в 30 фт. шириной 5 фт. (выбираете форму каждый раз). Существа в этой области проходят проверку Ловкости сложностью 8 + {mod:Телосложения} + {profBonus:}. При провале получают d10 урона согласно вашему драконьему наследию, а при успехе — половину этого значения. Вы можете использовать эту атаку {profBonus:} раз в день']
	}),
	[EBaseSpecies.dwarf]: createBaseDescription(EDarkvision.dv120, {
		...
		features: [
			...
			'Максимальный запас хитов увеличен на {level:}',
			'Находясь на каменной поверхности или касаясь её, {profBonus:} раз в день бонусным действием можно на 10 минут получить {Чувство вибрации} в пределах 60 фт.',
		],
	...
	[EBaseSpecies.human]: createBaseDescription({
		...
		features: [
			...
			'Получаете дополнительную черту происхождения на выбор'
		],
	}),
	[EBaseSpecies.orc]: createBaseDescription(EDarkvision.dv120, {
		name: 'Орк',
		features: [
			'[Всплеск адреналина.] Бонусным действием можете сделать {Рывок}, при этом получаете {profBonus:} временных хитов. Действие доступно {profBonus:} раз до отдыха',
...
export const fullSpeciesList: TSpecies[] = [
	...
	mkSpecies(EBaseSpecies.gnome, ESpecies['gnome.forest'], {
		name: 'Лесной гном',
		features: ['Знаете заговор {cantrip:Малая иллюзия}, и у вас всегда подготовлено заклинание {spell:Разговор с животными}, которое за день можете накладывать {profBonus:} раз, не тратя ячейку заклинаний. Также можете накладывать его, используя любые ячейки заклинаний'],
	}),
	...
	mkSpecies(EBaseSpecies.goliath, ESpecies['goliath.stone'], {
		...
		features: ['[Выносливость камня.] Когда получаете урон, можете реакцией бросить d12, добавить к результату {mod:Телосложения} и уменьшить урон на полученное значение']
	}),
	mkSpecies(EBaseSpecies.goliath, ESpecies['goliath.frost'], {
		name: 'Ледяной великан',
		features: ['[Морозный холод.] Когда попадаете атакой по цели и наносите урон, можете нанести дополнительно d6 урона холодом и снизить её скорость на 10 фт. до начала вашего следующего хода']
	}),
...
//TODO Нужно разделять характеристики, полученные из разных источников: черт, предыстории, класса. Видимо, путём добавления ещё одной строчки специального формата. Нужно, чтобы это можно было отключать
