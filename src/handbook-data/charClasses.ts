...
export const fullCharClassesList: TCharClass[] = [{
	...
	diff: {
		...
		weaponProficiencies: allWeapons,
		features: [
			'Выберите 2 навыка из следующих: {Акробатика}, {Атлетика}, {Внимательность}, {Выживание}, {Запугивание}, {История}, {Проницательность}, {Убеждение}, {Уход за животными}',
	...
	diff: {
		...
		features: [
			...
			'Можете добавлять {mod:Ловкости} вместо {mod:Силы} при атаке монашеским оружием или безоружным ударом, также и для сложности спасброска, если делаете {Захват} или толчок при нанесении безоружного удара',
	...
	diff: {
		...
		weaponProficiencies: simpleWeapons,
		features: [
			'Выберите 2 навыка из следующих: {Аркана}, {Запугивание}, {Обман}, {Проницательность}, {Религия}, {Убеждение}',
			'Знаете {class:sorcerer/cantrips} заговоров  и {class:sorcerer/preparedSpells} заклинаний',
			'Заклинательная характеристика - {Харизма}',
